...
public class SellerLogin {
	...
	public String UserLogin(String UserName, String Password)
	{
		...
		sb.append("SELECT NEW entity.SellerInfo(s.email, s.mobile, s.seller_code, s.shop_name, 'S') ");
		sb.append(" FROM SellerInfo s, SellerPassword p");
		sb.append(" where s.seller_id = p.seller_id ");
	...
	public Map<String, Object> SaveSellerRegistration(String shop_name, String mobile, String email, String Password) 
	{
		...
		try {
			...
			hb.addParameter("p_user_type", "S", String.class, ParameterMode.IN);
