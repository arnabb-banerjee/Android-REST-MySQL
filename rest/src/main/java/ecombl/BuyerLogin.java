...
public class BuyerLogin {
	...
	public String UserLogin(String UserName, String Password)
	{
		try {
			...
			sb.append("SELECT NEW entity.BuyerInfo(s.email, s.mobile, s.buyer_code, 'B') ");
			sb.append(" FROM BuyerInfo s, BuyerPassword p");
			sb.append(" where s.buyer_id = p.buyer_id ");
			sb.append(" and (s.email = :UserName or s.mobile = :UserName) ");
	...
	public Map<String, Object> SaveBuyerRegistration(String mobile, String email, String Password) 
	{
		...
		try {
			...
			hb.addParameter("p_user_type", "B", String.class, ParameterMode.IN);
			hb.addParameter("p_uer_code", "", String.class, ParameterMode.IN);
			hb.addParameter("p_shop_name", "", String.class, ParameterMode.IN);
	...
	/*public String SaveBuyerRegistration(String mobile, String email, String Password) 
	{
		String out_userid = "";
		Metadata meta = new MetadataSources(common.ssr).getMetadataBuilder().build();  
		SessionFactory factory = meta.getSessionFactoryBuilder().build();  
		...
		try 
	    {
			...
			seller_registration.setParameter("p_user_type", "B");
			seller_registration.setParameter("p_uer_code", "");
			seller_registration.setParameter("p_shop_name", "");
